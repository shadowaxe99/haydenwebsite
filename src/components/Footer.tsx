...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-cream py-16 md:py-24 px-6 border-t border-brand-navy/5 overflow-hidden">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 md:gap-16 mb-16 md:mb-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-12 md:gap-24 w-full md:w-auto">
            ...
            <motion.div 
              ...
              className="col-span-2 md:col-span-1 flex justify-start md:justify-end"
            >
              <button 
                onClick={scrollToTop}
        ...
        <motion.div 
          ...
          className="pt-8 md:pt-12 border-t border-brand-navy/5 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left"
        >
